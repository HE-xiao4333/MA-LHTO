...
class multiagent(object):
    def __init__(self,Dev_number,state_dim_Dev,action_dim_xy,action_dim_z,action_dim_f,learning_rate=0.001, training_interval=5, batch_size=64,memory_size=10000,entropy_weight=0.01):
